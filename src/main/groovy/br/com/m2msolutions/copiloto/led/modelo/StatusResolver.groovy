...
class StatusResolver {
    ...
    private criarStatus(){
        ...
        todosOsStatus = [
            new Status(tempoMinimo: Double.NEGATIVE_INFINITY,tempoMaximo: -3.1, codigo: 'fff80000'),
            ...
            new Status(tempoMinimo: 3.1,tempoMaximo: Double.POSITIVE_INFINITY ,codigo: '0001fff8')
        ]
    }
}
